...
def convert_audio(link: str, start_timestamp: str, end_timestamp: str, destination_folder: str):
    ...
    if start_timestamp and end_timestamp:
        command_trim = f'ffmpeg -ss {start_timestamp} -to {end_timestamp} -i "{file_path}" "{file_path}.mp3"'
    elif start_timestamp:
        command_trim = f'ffmpeg -ss {start_timestamp} -i "{file_path}" "{file_path}.mp3"'
    ...
    if command_trim != '':
        ...
        move(file_path, f'{file_path}.mp3')
